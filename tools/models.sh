...
# We strip FTS5 virtual tables and triggers from the schema because dbtpl
# doesn't support them (and we don't need models for them)
rm -f dbtpl.db
sed -E '/CREATE VIRTUAL TABLE/,/;$/d; /CREATE TRIGGER/,/^END;$/d' schema.sql | sqlite3 'dbtpl.db'
